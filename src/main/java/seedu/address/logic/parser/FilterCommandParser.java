...
import static seedu.address.logic.commands.FilterCommand.ERROR_MESSAGE_INVALID_FORMAT;
import static seedu.address.logic.commands.FilterCommand.ERROR_MESSAGE_INVALID_TAG;
    ...
    public FilterCommand parse(String args) throws ParseException {
        ...
        for (String string: nameKeywords) {
            if (string.contains(PREFIX_DATE.toString())) {
                return new FilterCommand(new TaskBetweenDatesPredicate(inBetweenDates(trimmedArgs)));
            }
        }
