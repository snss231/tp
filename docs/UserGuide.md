...
| Prefix    | Meaning | Constraints                                                                                                                                                                                                                                                                                                                                                                                                                                                                                | 
|-----------|---------|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| `n/`      | Name of contact | Can only contain alphanumeric characters and selected symbols like `/`, `-` and `'`.                                                                                                                                                                                                                                                                                                                                                                                                       |
| `p/`      | Phone number of contact | Only numbers are allowed and must contain at least 3 digits. Only used in `addc` and `editc` commands.                                                                                                                                                                                                                                                                                                                                                                                     | 
...
| `u/`      | Github Username of contact | Github usernames can only consist of alphanumeric characters or hyphens as per Github conventions.                                                                                                                                                                                                                                                                                                                                                                                         |
| `t/`      | Tag of either contact or task | A Task cannot contain two duplicate tags.                                                                                                                                                                                                                                                                                                                                                                                                                                                  |
| `INDEX`   | Index of the task or contact specified | `INDEX` refers to the index number as listed in NUS Classes, e.g. `INDEX` of `1` would mean the first task/contact.                                                                                                                                                                                                                                                                                                                                                                        |
| `KEYWORD` | Keyword of the task or contact. This can be the name or tag or tasks/contacts | `KEYWORD` is case-insensitive. Orders of `KEYWORD`s do not matter. Only full words will be matched.                                                                                                                                                                                                                                                                                                                                                                                        |
| `tn/`     | Task name of the task | Two tasks with the same `TASKNAME` is valid.                                                                                                                                                                                                                                                                                                                                                                                                                                               |
| `dt/`     | Date and time of the task. Can include both start and end times, or simply a single time. | Needs to be in the format dd-mm-yyyy hhmm                                                                                                                                                                                                                                                                                                                                                                                                                                                  |
| `z/`      | Link to online meeting/video conferencing. | Only valid links are accepted, with `https://` or `http://`.                                                                                                                                                                                                                                                                                                                                                                                                                               |
| `r/`      | Interval and recurrence of the task. | Pre-set values like `daily`, `weekly`, `monthly`, `quarterly` and `annually` are accepted. Else, only positive non-zero integers are valid.                                                                                                                                                                                                                                                                                                                                                |
| `p/` | Index of the contact being assigned to a task. | This is only used in `assign` and `unassign`. It is separate from `PHONENUMBER` in `addc` and `editc`.                                                                                                                                                                                                                                                                                                                                                                                     |
| `all/`| Shows all tasks in the list. | Only used in `listt`.                                                                                                                                                                                                                                                                                                                                                                                                                                                                      |
| `c/` | Shows all completed tasks in the list. | Only used in `listt`. |
| `nc/` | Shows all uncompleted tasks in the list. | Only used in `listt`.|
